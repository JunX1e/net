			...
			<div id="mr-content" class="mr-content col-xs-12">
				<div class="login-wrap" style="margin-bottom: 60px; margin-top: 50px">
					<div style="max-width: 540px; margin: 0 auto;">
						<a href="index.jsp" title="点击返回首页"><img src="images/musiclogo.png"></a>
					</div>
					<div class="login">
						...
						<form id="member-registration" action="register_deal.jsp"
							...
							<fieldset>
								<div class="form-group">
									...
									<div class="col-sm-8">
										...
										<input type="text" name="username" id="username" value=""
											class="required" size="30" required="required"
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										...
										<input type="password" name="pwd" id="pwd" value=""
											...
											size="40" maxlength="99" required="required"
											aria-required="true"><span class="star">&nbsp;*</span>
									</div>
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									...
									<div class="col-sm-8" style="clear: none;">
										...
										<input type="email" name="email" class="validate-email"
											id="jform_email2" value="" size="40" aria-required="true">
									</div>
								</div>
								<div class="form-group">
									<div style="float: right; padding-right: 216px;">
										音乐网站<a href="agreement.html" style="color: #0885B1;">《使用条款》</a>
									</div>
								</div>
								<div class="form-group">
								...
								<div class="form-group" style="margin: 20px;">
									<label
										style="float: right; color: #808080; margin-right: 80px; margin-top: 10px; font-size: 14px;">已有账号！
										<a
